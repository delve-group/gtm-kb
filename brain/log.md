...
* **Creation**: Added the initial VIBE CODING SUMMER JAM event brief with an explicit date conflict requiring confirmation.
* **Creation**: Added a one-prompt LinkedIn campaign recipe and repository-local Codex skill.
* **Creation**: Added deterministic catalog validation and artifact boundaries.
